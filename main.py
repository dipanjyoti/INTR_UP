...
def setup_parser():
    ...
    parser.add_argument('--pretrained_weights', type=str, default='vit_base_patch16_224_in21k',
                        choices=['vit_base_patch16_224_in21k', 'vit_base_mae', 'vit_base_patch14_dinov2','vit_base_patch16_dino',
                                 'vit_base_patch16_clip_224', 'biomedclip_vit_base_patch16_224', 'vit_large_patch14_bioclip2_224'],
    ...
    parser.add_argument('--adapter', type=str, default=None, choices=['Adapter_CrossNonParam', 'Adapter_SelfParam_CrossNonParam', 'Adapter_SelfNonParam_CrossNonParam', 
                            'Adapter_SelfParam_CrossParam', 'Adapter_CrossParam'],
                        help='Use of adapater')
    parser.add_argument('--adapt_SA', default=True, type=bool,
                        help='Use of SA in adapter module or not? For medical images it is False. For biodiversity images it is True. (default: %(default)s)')
