...
def setup_parser():
    ...
    parser.add_argument('--nmbr_samples', default=20, type=int, help='Number of samples to visualize')
    ...
    parser.add_argument('--adapter', type=str, default=None, choices=['DVPTAdapter', 'DVPTAdapterSA', 'MLPAdapter', 
                        'MLPAdapterCA', 'MLPPromptAdapter', 'MLPPromptAdapterCA'],
